namespace csc
{
	partial class SelectFolder
	{
		...
		private void InitializeComponent()
		{
			...
			driveListBox1.Drives = new string[] { "C:\\", "D:\\", "E:\\", "F:\\", "G:\\" };
			...
			driveListBox1.Items.AddRange(new object[] { "C (Windows)", "D (Recovery Image)", "E (ボリューム)", "F (HDCZ-UT)", "G (Google Drive)" });
			driveListBox1.Location = new Point(0, 0);
			driveListBox1.Name = "driveListBox1";
			driveListBox1.SelectedColor = SystemColors.WindowFrame;
			driveListBox1.Size = new Size(171, 311);
			...
			directoryListBox1.Size = new Size(266, 311);
			directoryListBox1.TabIndex = 0;
			directoryListBox1.UserBtn = null;
			// 
			// ToDeskTop
			// 
			...
			ToDeskTop.Location = new Point(35, 408);
			...
			dirFileListBox1.Size = new Size(218, 311);
			...
			tbTargetDir.Font = new Font("Yu Gothic UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
			tbTargetDir.ForeColor = Color.FromArgb(230, 230, 230);
			tbTargetDir.Location = new Point(24, 383);
			...
			btnParent.Location = new Point(591, 32);
			...
			btnRoot.Location = new Point(489, 32);
			...
			splitContainer1.Size = new Size(663, 311);
			...
			splitContainer2.Size = new Size(488, 311);
			...
			btnCancel.Location = new Point(467, 408);
			...
			btnOK.Location = new Point(569, 408);
			btnOK.Name = "btnOK";
			...
			btnUser.Location = new Point(239, 408);
