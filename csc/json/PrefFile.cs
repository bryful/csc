...
namespace csc
{
	public class PrefFile
	{
		...
		public string PrefName { get { return m_PrefName; } }
		// *********************************
		...
		public PrefFile(Form fm,string prefName = "")
		{
			...
			m_AppDataPath = Path.Combine(m_AppDataDirectory, m_PrefName + ".json");
